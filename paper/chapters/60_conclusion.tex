...
This paper presented a three-stage empirical evaluation of Lightpanda as a drop-in replacement for Google Chrome Headless in Playwright-based end-to-end test pipelines. The headline finding is clear: \textbf{Lightpanda is not production-ready and cannot replace Chrome Headless for real-world E2E testing in its current form.}
